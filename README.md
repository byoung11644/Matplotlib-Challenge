...
* Using Matplotlib, generate a box and whisker plot of the final tumor volume for all four treatment regimens and highlight any potential outliers in the plot by changing their color and style.
  ...
  **Considerations**: All four box plots should be within the same figure. Use this [Matplotlib documentation page](https://matplotlib.org/gallery/pyplots/boxplot_demo_pyplot.html#sphx-glr-gallery-pyplots-boxplot-demo-pyplot-py) for help with changing the style of the outliers.
...
* Don't get bogged down in small details. Always focus on the big picture.

* Remember, there are many ways to approach a data problem. The key is to break up tasks into micro tasks. Try answering questions like:
